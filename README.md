...
<div align="center">
  <img src="https://img.shields.io/badge/version-v1.7.0-green" alt="version" />
...
### 현재 버전 (v1.7.0)
- **로그아웃 기능**: 사용자가 안전하게 세션을 종료할 수 있는 로그아웃 기능
- **헤더 UI**: 애플리케이션 제목과 사용자 정보를 표시하는 상단 헤더
- **파스텔톤 녹색 테마**: 일관된 디자인 시스템과 반응형 UI
- **보안 강화**: 로컬 스토리지 정리 및 상태 초기화로 안전한 로그아웃
- **기존 기능**: 태스크 삭제, 드래그 앤 드롭, 로그인/회원가입, JWT 인증, 칸반 보드 등
...
| v1.7.0 | 2025-01-27 | 로그아웃 기능, 헤더 UI, 파스텔톤 녹색 테마 통합 |
| v1.8.0 | (예정) | MCP(Multi-Context Protocol) 도입 예정 |
